window.onload = () => {
  ...
  gameVariables.img.onload = () => {    
    ...
    duck.style.backgroundImage = `url(${gameVariables.img.src})`;
    duck.style.width = `26px`;
    duck.style.height = `32px`;
    duck.style.backgroundPosition = `${8*gameVariables.SPRITE_WIDTH}px ${
