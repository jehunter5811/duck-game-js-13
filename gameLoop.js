...
const drawFrame = (frameX, frameY) => {  
  const x = `${gameVariables.SPRITE_WIDTH * frameX}px`;
  const y = `${gameVariables.SPRITE_HEIGHT * frameY}px`;
...
const layEgg = async () => {
  if (gameVariables.eggTimer === gameVariables.MAX_EGG_TIMER) {
    ...
    egg.style.background = "url(data:image/png;base64,)";
